...
export const hi = {
  ...
  friends: {
    ...
    stats: {
      ...
      activeSharing: "सक्रिय साझाकरण",
      blockedUsers: "अवरुद्ध उपयोगकर्ता",
    },
    search: {
      placeholder: "मित्र खोजें...",
      usersPlaceholder: "उपयोगकर्ता खोजें...",
      noResults: "कोई मिलान नहीं मिला",
    },
    requests: {
      incoming: "आने वाले",
      outgoing: "भेजे गए",
      allPending: "सभी लंबित",
      accept: "स्वीकार करें",
      reject: "अस्वीकार करें",
      cancel: "अनुरोध रद्द करें",
      sendRequest: "मित्र अनुरोध भेजें",
      requestSent: "अनुरोध भेजा गया",
      noIncoming: "कोई आने वाला मित्र अनुरोध नहीं",
      noOutgoing: "कोई भेजा गया मित्र अनुरोध नहीं",
      noPending: "कोई लंबित अनुरोध नहीं",
      sentOn: "{{date}} को भेजा गया",
      receivedOn: "{{date}} को प्राप्त",
    },
    sharing: {
      sharedWithMe: "मेरे साथ साझा",
      iSharedWith: "मैंने साझा किया",
      summary: "साझाकरण सारांश",
      quickShare: "त्वरित साझा",
      batchShare: "बैच साझा",
      batchShareTitle: "कई मित्रों के साथ साझा करें",
      recommended: "साझा करने के लिए अनुशंसित",
      accessLevel: "पहुँच स्तर",
      selectFriends: "साझा करने के लिए मित्र चुनें",
      selectAccessLevel: "सभी के लिए पहुँच स्तर चुनें",
      applyShare: "साझाकरण लागू करें",
      revokeAccess: "पहुँच हटाएँ",
      totalSharing: "कुल साझाकरण",
      incomingShares: "आने वाले साझा",
      outgoingShares: "भेजे गए साझा",
      noSharedWithMe: "अभी तक किसी ने आपके साथ खर्चे साझा नहीं किए",
      noISharedWith: "आपने अभी तक किसी के साथ खर्चे साझा नहीं किए",
      noRecommendations: "कोई साझाकरण अनुशंसा उपलब्ध नहीं",
    },
    accessLevels: {
      none: "कोई पहुँच नहीं",
      noneDesc: "कोई डेटा नहीं देख सकते",
      read: "केवल देखें",
      readDesc: "खर्चे देख सकते हैं",
      write: "संपादित कर सकते हैं",
      writeDesc: "खर्चे देख और संपादित कर सकते हैं",
      full: "पूर्ण पहुँच",
      fullDesc: "देख, संपादित और प्रबंधित कर सकते हैं",
      limited: "सीमित",
      summary: "केवल सारांश",
    },
    actions: {
      removeFriend: "मित्र हटाएँ",
      blockUser: "उपयोगकर्ता अवरुद्ध करें",
      unblockUser: "अवरुद्ध हटाएँ",
      viewExpenses: "खर्चे देखें",
      manageAccess: "पहुँच प्रबंधित करें",
      viewProfile: "प्रोफ़ाइल देखें",
      viewMutualFriends: "सामान्य मित्र देखें",
      confirmRemove: "{{name}} को मित्रों से हटाएँ?",
      confirmBlock: "{{name}} को अवरुद्ध करें? वे आपसे संपर्क नहीं कर पाएँगे।",
    },
    discover: {
      title: "खोजें",
      searchPlaceholder: "मित्र खोजें...",
      suggestions: "जिन्हें आप जानते हों",
      searchUsers: "उपयोगकर्ता खोजें",
      mutualFriends: "{{count}} सामान्य मित्र",
      oneMutualFriend: "1 सामान्य मित्र",
      noSuggestions: "अभी कोई सुझाव उपलब्ध नहीं",
      noSearchResults: "\"{{query}}\" के लिए कोई उपयोगकर्ता नहीं मिला",
      addFriend: "मित्र जोड़ें",
      requestPending: "अनुरोध लंबित",
    },
    blocked: {
      title: "अवरुद्ध उपयोगकर्ता",
      empty: "आपने किसी को अवरुद्ध नहीं किया है",
      emptyDesc: "अवरुद्ध उपयोगकर्ता आपको मित्र अनुरोध नहीं भेज सकते",
      confirmUnblock: "{{name}} को अनवरुद्ध करें?",
      unblockDesc: "वे फिर से आपको मित्र अनुरोध भेज सकेंगे",
      blockedOn: "{{date}} को अवरुद्ध किया",
    },
    detail: {
      friendSince: "{{date}} से मित्र",
      currentAccess: "वर्तमान पहुँच",
      mutualFriends: "सामान्य मित्र",
      noMutualFriends: "कोई सामान्य मित्र नहीं",
      friendshipDetails: "मित्रता विवरण",
    },
    report: {
      title: "मित्रता रिपोर्ट",
      dateRange: "तिथि सीमा",
      fromDate: "से तिथि",
      toDate: "तक तिथि",
      status: "स्थिति",
    ...
    filters: {
      ...
      hasAccess: "पहुँच है",
      noAccess: "पहुँच नहीं",
      fullBothWays: "दोनों तरफ पूर्ण",
      accessGranted: "पहुँच दी गई",
      incomingOnly: "केवल आने वाले",
      outgoingOnly: "केवल भेजे गए",
      recent: "हाल के (7 दिन)",
      nameAM: "नाम A-M",
      nameNZ: "नाम N-Z",
    },
    empty: {
      myFriends: "आपने अभी तक कोई मित्र नहीं जोड़ा",
    ...
    toast: {
      ...
      requestAccepted: "अब आप {{name}} के मित्र हैं",
      requestRejected: "{{name}} का मित्र अनुरोध अस्वीकृत",
      requestCancelled: "मित्र अनुरोध रद्द किया गया",
      friendRemoved: "{{name}} को मित्रों से हटाया गया",
      userBlocked: "{{name}} को अवरुद्ध किया गया",
      userUnblocked: "{{name}} को अनवरुद्ध किया गया",
      accessUpdated: "पहुँच स्तर {{level}} पर अपडेट किया गया",
      sharingApplied: "{{count}} मित्रों पर साझाकरण लागू किया गया",
      errorGeneric: "कुछ गलत हो गया। कृपया पुनः प्रयास करें।",
    },
    activity: "मित्र गतिविधि",
    refreshing: "ताज़ा हो रहा है...",
    loginRequired: "मित्रों को देखने के लिए लॉग इन करें",
  },
