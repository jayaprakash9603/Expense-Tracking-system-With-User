...
export const en = {
  ...
  friends: {
    ...
    sharing: {
      sharedWithMe: "Shared With Me",
      iSharedWith: "I Shared With",
      summary: "Sharing Summary",
      quickShare: "Quick Share",
      batchShare: "Batch Share",
      batchShareTitle: "Share With Multiple Friends",
      recommended: "Recommended to Share",
      accessLevel: "Access Level",
      selectFriends: "Select friends to share with",
      selectAccessLevel: "Select access level for all",
      applyShare: "Apply Sharing",
      revokeAccess: "Revoke Access",
      totalSharing: "Total Sharing",
      incomingShares: "Incoming Shares",
      outgoingShares: "Outgoing Shares",
      noSharedWithMe: "No one has shared expenses with you yet",
      noISharedWith: "You haven't shared expenses with anyone yet",
      noRecommendations: "No sharing recommendations available",
    },
    accessLevels: {
      none: "No Access",
      noneDesc: "Cannot view any data",
      read: "View Only",
      readDesc: "Can view expenses",
      write: "Can Edit",
      writeDesc: "Can view and edit expenses",
      full: "Full Access",
      fullDesc: "Can view, edit, and manage",
      limited: "Limited",
    ...
    actions: {
      ...
      viewProfile: "View Profile",
      viewMutualFriends: "View Mutual Friends",
      confirmRemove: "Remove {{name}} from friends?",
      confirmBlock: "Block {{name}}? They won't be able to contact you.",
    },
    discover: {
      title: "Discover",
      searchPlaceholder: "Search friends...",
      ...
      oneMutualFriend: "1 mutual friend",
    ...
    blocked: {
      ...
      emptyDesc: "Blocked users cannot send you friend requests or view your profile",
      confirmUnblock: "Unblock {{name}}?",
      unblockDesc: "They will be able to send you friend requests again",
    ...
    detail: {
      ...
      friendshipDetails: "Friendship Details",
    },
    report: {
    ...
    empty: {
      myFriends: "You haven't added any friends yet",
      myFriendsDesc: "Go to Discover to find people you know",
      requests: "No pending friend requests",
      requestsDesc: "When someone sends you a request, it will appear here",
      discover: "No suggestions right now",
      discoverDesc: "Check back later for people you may know",
      sharing: "No shared expenses",
      sharingDesc: "Share your expenses with friends to collaborate on budgets",
      blocked: "No blocked users",
      blockedDesc: "Blocked users cannot interact with you",
      report: "No report data",
      reportDesc: "Generate a report to see friendship statistics",
    },
    status: {
      PENDING: "Pending",
      ACCEPTED: "Accepted",
    ...
    toast: {
      ...
      requestAccepted: "You are now friends with {{name}}",
      requestRejected: "Friend request from {{name}} declined",
      requestCancelled: "Friend request cancelled",
      friendRemoved: "{{name}} removed from friends",
      userBlocked: "{{name}} has been blocked",
      userUnblocked: "{{name}} has been unblocked",
      accessUpdated: "Access level updated to {{level}}",
      sharingApplied: "Sharing applied to {{count}} friends",
      errorGeneric: "Something went wrong. Please try again.",
    },
    activity: "Friend Activity",
    refreshing: "Refreshing...",
    loginRequired: "Please log in to view friends",
  },
