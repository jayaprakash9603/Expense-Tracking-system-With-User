...
export const te = {
  ...
  friends: {
    ...
    sections: {
      ...
      discover: "కనుగొనండి",
      sharing: "షేరింగ్",
      blocked: "బ్లాక్ చేసినవి",
      report: "రిపోర్ట్",
    },
    stats: {
      totalFriends: "మొత్తం స్నేహితులు",
      pendingRequests: "పెండింగ్ అభ్యర్థనలు",
      activeSharing: "యాక్టివ్ షేరింగ్",
      blockedUsers: "బ్లాక్ చేసిన వినియోగదారులు",
    },
    search: {
      placeholder: "స్నేహితులను శోధించండి...",
      usersPlaceholder: "వినియోగదారులను శోధించండి...",
      noResults: "పోలికలు కనబడలేదు",
    },
    requests: {
      incoming: "వచ్చినవి",
      outgoing: "పంపినవి",
      allPending: "అన్ని పెండింగ్",
      accept: "అంగీకరించండి",
      reject: "తిరస్కరించండి",
      cancel: "అభ్యర్థన రద్దు చేయండి",
      sendRequest: "స్నేహం అభ్యర్థన పంపండి",
      requestSent: "అభ్యర్థన పంపబడింది",
      noIncoming: "వచ్చిన స్నేహం అభ్యర్థనలు లేవు",
      noOutgoing: "పంపిన స్నేహం అభ్యర్థనలు లేవు",
      noPending: "పెండింగ్ అభ్యర్థనలు లేవు",
      sentOn: "{{date}} న పంపబడింది",
      receivedOn: "{{date}} న అందింది",
    },
    sharing: {
      sharedWithMe: "నాతో షేర్ చేసినవి",
      iSharedWith: "నేను షేర్ చేసినవి",
      summary: "షేరింగ్ సారాంశం",
      quickShare: "క్విక్ షేర్",
      batchShare: "బ్యాచ్ షేర్",
      batchShareTitle: "చాలా స్నేహితులతో షేర్ చేయండి",
      recommended: "షేర్ చేయడానికి సిఫార్సు",
      accessLevel: "యాక్సెస్ స్థాయి",
      selectFriends: "షేర్ చేయడానికి స్నేహితులను ఎంచుకోండి",
      selectAccessLevel: "అందరికీ యాక్సెస్ స్థాయిని ఎంచుకోండి",
      applyShare: "షేరింగ్ అప్లై చేయండి",
      revokeAccess: "యాక్సెస్ తొలగించండి",
      totalSharing: "మొత్తం షేరింగ్",
      incomingShares: "వచ్చిన షేర్‌లు",
      outgoingShares: "పంపిన షేర్‌లు",
      noSharedWithMe: "ఇంకా ఎవరూ మీతో ఖర్చులు షేర్ చేయలేదు",
      noISharedWith: "మీరు ఇంకా ఎవరితోనూ ఖర్చులు షేర్ చేయలేదు",
      noRecommendations: "షేరింగ్ సిఫార్సులు అందుబాటులో లేవు",
    },
    accessLevels: {
      none: "యాక్సెస్ లేదు",
      noneDesc: "ఎటువంటి డేటా చూడలేరు",
      read: "చూడటం మాత్రమే",
      readDesc: "ఖర్చులు చూడగలరు",
      write: "సవరించగలరు",
      writeDesc: "ఖర్చులు చూడగలరు మరియు సవరించగలరు",
      full: "పూర్తి యాక్సెస్",
      fullDesc: "చూడగలరు, సవరించగలరు మరియు నిర్వహించగలరు",
      limited: "పరిమితం",
      summary: "సారాంశం మాత్రమే",
    },
    actions: {
      removeFriend: "స్నేహితుడిని తొలగించండి",
      blockUser: "వినియోగదారుడిని బ్లాక్ చేయండి",
      unblockUser: "అన్‌బ్లాక్ చేయండి",
      viewExpenses: "ఖర్చులు చూడండి",
      manageAccess: "యాక్సెస్ నిర్వహించండి",
      viewProfile: "ప్రొఫైల్ చూడండి",
      viewMutualFriends: "ఉమ్మడి స్నేహితులను చూడండి",
      confirmRemove: "{{name}} ను స్నేహితుల నుండి తొలగించాలా?",
      confirmBlock: "{{name}} ను బ్లాక్ చేయాలా? వారు మీకు సందేశం పంపలేరు.",
    },
    discover: {
      title: "కనుగొనండి",
      searchPlaceholder: "స్నేహితులను శోధించండి...",
      suggestions: "మీకు తెలిసిన వాళ్ళు",
      searchUsers: "వినియోగదారులను శోధించండి",
      mutualFriends: "{{count}} ఉమ్మడి స్నేహితులు",
      oneMutualFriend: "1 ఉమ్మడి స్నేహితుడు",
      noSuggestions: "ప్రస్తుతం సూచనలు అందుబాటులో లేవు",
      noSearchResults: "\"{{query}}\" కు వినియోగదారులు కనుగొనబడలేదు",
      addFriend: "స్నేహితుడిని జోడించండి",
      requestPending: "అభ్యర్థన పెండింగ్‌లో",
    },
    blocked: {
      title: "బ్లాక్ చేసిన వినియోగదారులు",
      empty: "మీరు ఎవరినీ బ్లాక్ చేయలేదు",
      emptyDesc: "బ్లాక్ చేసిన వినియోగదారులు మీకు స్నేహం అభ్యర్థనలు పంపలేరు",
      confirmUnblock: "{{name}} ను అన్‌బ్లాక్ చేయాలా?",
      unblockDesc: "వారు మళ్ళీ మీకు స్నేహం అభ్యర్థనలు పంపగలరు",
      blockedOn: "{{date}} న బ్లాక్ చేయబడింది",
    },
    detail: {
      friendSince: "{{date}} నుండి స్నేహితులు",
      currentAccess: "ప్రస్తుత యాక్సెస్",
      mutualFriends: "ఉమ్మడి స్నేహితులు",
      noMutualFriends: "ఉమ్మడి స్నేహితులు లేరు",
      friendshipDetails: "స్నేహం వివరాలు",
    },
    report: {
      title: "స్నేహం రిపోర్ట్",
      dateRange: "తేదీ పరిధి",
      fromDate: "నుండి తేదీ",
      toDate: "వరకు తేదీ",
      status: "స్థితి",
      sortBy: "క్రమం",
      sortDirection: "క్రమ దిశ",
      ascending: "ఆరోహణం",
      descending: "అవరోహణం",
      pageSize: "పేజీ పరిమాణం",
      generateReport: "రిపోర్ట్ రూపొందించండి",
      generatePrompt: "ఫిల్టర్లను ఎంచుకుని స్నేహం డేటాను చూడటానికి రిపోర్ట్ రూపొందించండి పై క్లిక్ చేయండి",
      allStatuses: "అన్ని స్థితులు",
      noReportData: "రిపోర్ట్ డేటా అందుబాటులో లేదు",
      totalFriendships: "మొత్తం స్నేహాలు",
      columns: {
        friend: "స్నేహితుడు",
        status: "స్థితి",
        accessLevel: "యాక్సెస్ స్థాయి",
    ...
    filters: {
      all: "అన్నీ",
      hasAccess: "యాక్సెస్ ఉంది",
      noAccess: "యాక్సెస్ లేదు",
      fullBothWays: "రెండు వైపులా పూర్తి",
      accessGranted: "యాక్సెస్ ఇవ్వబడింది",
      incomingOnly: "వచ్చినవి మాత్రమే",
      outgoingOnly: "పంపినవి మాత్రమే",
      recent: "ఇటీవలి (7 రోజులు)",
      nameAM: "పేరు A-M",
      nameNZ: "పేరు N-Z",
    },
    empty: {
      myFriends: "మీరు ఇంకా స్నేహితులను జోడించలేదు",
      myFriendsDesc: "మీకు తెలిసిన వాళ్ళను కనుగొనడానికి కనుగొనండి పేజీకి వెళ్ళండి",
      requests: "పెండింగ్ స్నేహం అభ్యర్థనలు లేవు",
      requestsDesc: "ఎవరైనా మీకు అభ్యర్థన పంపినప్పుడు, ఇక్కడ కనిపిస్తుంది",
      discover: "ప్రస్తుతం సూచనలు లేవు",
      discoverDesc: "మీకు తెలిసిన వాళ్ళ కోసం తర్వాత తిరిగి చూడండి",
      sharing: "షేర్ చేసిన ఖర్చులు లేవు",
      sharingDesc: "బడ్జెట్‌లపై కలిసి పని చేయడానికి స్నేహితులతో ఖర్చులు షేర్ చేయండి",
      blocked: "బ్లాక్ చేసిన వినియోగదారులు లేరు",
      blockedDesc: "బ్లాక్ చేసిన వినియోగదారులు మీతో ఇంటరాక్ట్ చేయలేరు",
      report: "రిపోర్ట్ డేటా లేదు",
      reportDesc: "స్నేహం గణాంకాలు చూడటానికి రిపోర్ట్ రూపొందించండి",
    },
    status: {
      PENDING: "పెండింగ్",
    ...
    toast: {
      requestSent: "{{name}} కు స్నేహం అభ్యర్థన పంపబడింది",
      requestAccepted: "ఇప్పుడు మీరు {{name}} తో స్నేహితులు",
      requestRejected: "{{name}} స్నేహం అభ్యర్థన తిరస్కరించబడింది",
      requestCancelled: "స్నేహం అభ్యర్థన రద్దు చేయబడింది",
      friendRemoved: "{{name}} స్నేహితుల నుండి తొలగించబడింది",
      userBlocked: "{{name}} బ్లాక్ చేయబడింది",
      userUnblocked: "{{name}} అన్‌బ్లాక్ చేయబడింది",
      accessUpdated: "యాక్సెస్ స్థాయి {{level}} కు నవీకరించబడింది",
      sharingApplied: "{{count}} స్నేహితులకు షేరింగ్ అప్లై చేయబడింది",
      errorGeneric: "ఏదో తప్పు జరిగింది. దయచేసి మళ్ళీ ప్రయత్నించండి.",
    },
    activity: "స్నేహితుల కార్యకలాపం",
    refreshing: "రిఫ్రెష్ అవుతోంది...",
    loginRequired: "స్నేహితులను చూడటానికి లాగిన్ అవ్వండి",
  },
