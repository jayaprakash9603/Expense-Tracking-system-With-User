...
export const FETCH_PAYMENT_METHOD_ANALYTICS_REQUEST =
  "FETCH_PAYMENT_METHOD_ANALYTICS_REQUEST";
export const FETCH_PAYMENT_METHOD_ANALYTICS_SUCCESS =
  "FETCH_PAYMENT_METHOD_ANALYTICS_SUCCESS";
export const FETCH_PAYMENT_METHOD_ANALYTICS_FAILURE =
  "FETCH_PAYMENT_METHOD_ANALYTICS_FAILURE";
export const CLEAR_PAYMENT_METHOD_ANALYTICS =
