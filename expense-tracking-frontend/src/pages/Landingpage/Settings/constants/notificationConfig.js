...
export const NOTIFICATION_SERVICES = {
  ...
  CATEGORY_SERVICE: {
    ...
    description: "Notifications for category management and organization",
    icon: ReceiptIcon,
    color: "#06b6d4",
    notifications: [
      {
        ...
        description: "Get notified when a new category is created",
        icon: CheckCircleIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      },
      {
        ...
        description: "Get notified when a category is modified",
        icon: InfoIcon,
        priority: NOTIFICATION_PRIORITY.LOW,
        defaultEnabled: false,
        methods: {
      ...
      },
      {
        ...
        description: "Get notified when a category is removed",
        icon: InfoIcon,
        priority: NOTIFICATION_PRIORITY.LOW,
        defaultEnabled: false,
        methods: {
      ...
      },
      {
        ...
        description: "Alert when spending exceeds category budget limit",
        icon: WarningIcon,
        priority: NOTIFICATION_PRIORITY.HIGH,
        defaultEnabled: true,
        methods: {
  ...
  FRIEND_ACTIVITY_SERVICE: {
    id: "friend_activity_service",
    name: "Friend Activity Service",
    description:
      "Notifications when friends manage your expenses, categories, or bills",
    icon: GroupIcon,
    color: "#f97316",
    notifications: [
      {
        id: "friend_expense_created",
        type: "FRIEND_EXPENSE_CREATED",
        title: "Friend Created Expense",
        description: "Get notified when a friend creates an expense for you",
        icon: ReceiptIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_expense_updated",
        type: "FRIEND_EXPENSE_UPDATED",
        title: "Friend Updated Expense",
        description: "Get notified when a friend updates your expense",
        icon: InfoIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_expense_deleted",
        type: "FRIEND_EXPENSE_DELETED",
        title: "Friend Deleted Expense",
        description: "Get notified when a friend deletes your expense",
        icon: WarningIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_category_created",
        type: "FRIEND_CATEGORY_CREATED",
        title: "Friend Created Category",
        description: "Get notified when a friend creates a category for you",
        icon: CheckCircleIcon,
        priority: NOTIFICATION_PRIORITY.LOW,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_category_updated",
        type: "FRIEND_CATEGORY_UPDATED",
        title: "Friend Updated Category",
        description: "Get notified when a friend updates your category",
        icon: InfoIcon,
        priority: NOTIFICATION_PRIORITY.LOW,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_category_deleted",
        type: "FRIEND_CATEGORY_DELETED",
        title: "Friend Deleted Category",
        description: "Get notified when a friend deletes your category",
        icon: WarningIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_bill_created",
        type: "FRIEND_BILL_CREATED",
        title: "Friend Created Bill",
        description: "Get notified when a friend creates a bill for you",
        icon: ReceiptIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_bill_updated",
        type: "FRIEND_BILL_UPDATED",
        title: "Friend Updated Bill",
        description: "Get notified when a friend updates your bill",
        icon: InfoIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_bill_deleted",
        type: "FRIEND_BILL_DELETED",
        title: "Friend Deleted Bill",
        description: "Get notified when a friend deletes your bill",
        icon: WarningIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_budget_created",
        type: "FRIEND_BUDGET_CREATED",
        title: "Friend Created Budget",
        description: "Get notified when a friend creates a budget for you",
        icon: WalletIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_budget_updated",
        type: "FRIEND_BUDGET_UPDATED",
        title: "Friend Updated Budget",
        description: "Get notified when a friend updates your budget",
        icon: InfoIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_budget_deleted",
        type: "FRIEND_BUDGET_DELETED",
        title: "Friend Deleted Budget",
        description: "Get notified when a friend deletes your budget",
        icon: WarningIcon,
        priority: NOTIFICATION_PRIORITY.MEDIUM,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_payment_method_created",
        type: "FRIEND_PAYMENT_METHOD_CREATED",
        title: "Friend Added Payment Method",
        description: "Get notified when a friend adds a payment method for you",
        icon: PaymentIcon,
        priority: NOTIFICATION_PRIORITY.HIGH,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_payment_method_updated",
        type: "FRIEND_PAYMENT_METHOD_UPDATED",
        title: "Friend Updated Payment Method",
        description: "Get notified when a friend updates your payment method",
        icon: InfoIcon,
        priority: NOTIFICATION_PRIORITY.HIGH,
        defaultEnabled: true,
        methods: {
      ...
      {
        id: "friend_payment_method_deleted",
        type: "FRIEND_PAYMENT_METHOD_DELETED",
        title: "Friend Removed Payment Method",
        description: "Get notified when a friend removes your payment method",
        icon: WarningIcon,
        priority: NOTIFICATION_PRIORITY.HIGH,
        defaultEnabled: true,
        methods: {
