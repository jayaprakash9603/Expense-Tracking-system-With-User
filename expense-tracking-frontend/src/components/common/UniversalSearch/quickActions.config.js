...
export const TYPE_ICONS = {
  [SEARCH_TYPES.EXPENSE]: "expense",
  [SEARCH_TYPES.BUDGET]: "budget",
  [SEARCH_TYPES.CATEGORY]: "category",
  [SEARCH_TYPES.BILL]: "bill",
  [SEARCH_TYPES.PAYMENT_METHOD]: "payment",
  [SEARCH_TYPES.FRIEND]: "groups",
  [SEARCH_TYPES.USER]: "user",
  [SEARCH_TYPES.ACTION]: "action",
  [SEARCH_TYPES.REPORT]: "report",
  [SEARCH_TYPES.SETTING]: "settings",
  [SEARCH_TYPES.NOTIFICATION]: "notifications",
  [SEARCH_TYPES.HELP]: "help",
};
...
const filterByFeature = (actions, featureFlagsState) => {
  return actions.filter((action) =>
    isPathEnabledInState(featureFlagsState, action.route),
  );
};
