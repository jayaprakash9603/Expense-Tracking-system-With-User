...
public interface ExpenseService {
        ...
        List<Expense> filterExpenses(String expenseName, LocalDate startDate, LocalDate endDate, String type,
        ...
        List<MonthlySummary> getSummaryBetweenDates(Integer startYear, Integer startMonth, Integer endYear,
        ...
        Map<String, Map<String, Double>> getTotalByExpenseNameAndPaymentMethodForDateRange(LocalDate startDate,
        ...
        void sendEmailWithAttachment(String toEmail, String subject, String body, String attachmentPath)
        ...
        Map<String, Object> getPaymentMethodDistributionByDateRange(Integer userId, LocalDate startDate,
