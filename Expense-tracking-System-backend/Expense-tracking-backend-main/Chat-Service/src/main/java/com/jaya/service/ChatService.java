...
public interface ChatService {
    ...
    ChatResponse forwardMessage(Integer messageId, Integer targetUserId, Integer targetGroupId, Integer userId) throws Exception;
    ...
    ChatResponse sendMediaMessage(Integer recipientId, Integer groupId, String mediaUrl, String mediaType, String caption, Integer userId) throws Exception;
