...
/**
 * Kafka producer for Friend Activity events from Bill Service.
 * Sends notifications to Friendship Service when a friend performs bill actions
...
public class FriendActivityProducer extends NotificationEventProducer<FriendActivityEvent> {
    ...
    public FriendActivityProducer(KafkaTemplate<String, Object> kafkaTemplate,
        ...
        log.info("FriendActivityProducer initialized for Bill Service");
    }
