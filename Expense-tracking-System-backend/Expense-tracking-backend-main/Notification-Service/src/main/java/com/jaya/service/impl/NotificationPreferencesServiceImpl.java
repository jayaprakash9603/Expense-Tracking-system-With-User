...
public class NotificationPreferencesServiceImpl implements NotificationPreferencesService {
    ...
    @Override
    @Transactional
    public NotificationPreferencesResponseDTO updatePreferences(Integer userId, UpdateNotificationPreferencesRequest request) {
     ...
     */
    private void updateFieldsIfNotNull(NotificationPreferences preferences, UpdateNotificationPreferencesRequest request) {
        // Global Settings
        if (request.getMasterEnabled() != null) preferences.setMasterEnabled(request.getMasterEnabled());
        if (request.getDoNotDisturb() != null) preferences.setDoNotDisturb(request.getDoNotDisturb());
        if (request.getNotificationSound() != null) preferences.setNotificationSound(request.getNotificationSound());
        if (request.getBrowserNotifications() != null) preferences.setBrowserNotifications(request.getBrowserNotifications());
        
        // Service Level Toggles
        if (request.getExpenseServiceEnabled() != null) preferences.setExpenseServiceEnabled(request.getExpenseServiceEnabled());
        if (request.getBudgetServiceEnabled() != null) preferences.setBudgetServiceEnabled(request.getBudgetServiceEnabled());
        if (request.getBillServiceEnabled() != null) preferences.setBillServiceEnabled(request.getBillServiceEnabled());
        if (request.getPaymentMethodServiceEnabled() != null) preferences.setPaymentMethodServiceEnabled(request.getPaymentMethodServiceEnabled());
        if (request.getFriendServiceEnabled() != null) preferences.setFriendServiceEnabled(request.getFriendServiceEnabled());
        if (request.getAnalyticsServiceEnabled() != null) preferences.setAnalyticsServiceEnabled(request.getAnalyticsServiceEnabled());
        if (request.getSystemNotificationsEnabled() != null) preferences.setSystemNotificationsEnabled(request.getSystemNotificationsEnabled());
        
        // Expense Service Notifications
        if (request.getExpenseAddedEnabled() != null) preferences.setExpenseAddedEnabled(request.getExpenseAddedEnabled());
        if (request.getExpenseUpdatedEnabled() != null) preferences.setExpenseUpdatedEnabled(request.getExpenseUpdatedEnabled());
        if (request.getExpenseDeletedEnabled() != null) preferences.setExpenseDeletedEnabled(request.getExpenseDeletedEnabled());
        if (request.getLargeExpenseAlertEnabled() != null) preferences.setLargeExpenseAlertEnabled(request.getLargeExpenseAlertEnabled());
        
        // Budget Service Notifications
        if (request.getBudgetExceededEnabled() != null) preferences.setBudgetExceededEnabled(request.getBudgetExceededEnabled());
        if (request.getBudgetWarningEnabled() != null) preferences.setBudgetWarningEnabled(request.getBudgetWarningEnabled());
        if (request.getBudgetLimitApproachingEnabled() != null) preferences.setBudgetLimitApproachingEnabled(request.getBudgetLimitApproachingEnabled());
        if (request.getBudgetCreatedEnabled() != null) preferences.setBudgetCreatedEnabled(request.getBudgetCreatedEnabled());
        if (request.getBudgetUpdatedEnabled() != null) preferences.setBudgetUpdatedEnabled(request.getBudgetUpdatedEnabled());
        
        // Bill Service Notifications
        if (request.getBillDueReminderEnabled() != null) preferences.setBillDueReminderEnabled(request.getBillDueReminderEnabled());
        if (request.getBillOverdueEnabled() != null) preferences.setBillOverdueEnabled(request.getBillOverdueEnabled());
        if (request.getBillPaidEnabled() != null) preferences.setBillPaidEnabled(request.getBillPaidEnabled());
        
        // Payment Method Service Notifications
        if (request.getPaymentMethodAddedEnabled() != null) preferences.setPaymentMethodAddedEnabled(request.getPaymentMethodAddedEnabled());
        if (request.getPaymentMethodUpdatedEnabled() != null) preferences.setPaymentMethodUpdatedEnabled(request.getPaymentMethodUpdatedEnabled());
        if (request.getPaymentMethodRemovedEnabled() != null) preferences.setPaymentMethodRemovedEnabled(request.getPaymentMethodRemovedEnabled());
        
        // Friend Service Notifications
        if (request.getFriendRequestReceivedEnabled() != null) preferences.setFriendRequestReceivedEnabled(request.getFriendRequestReceivedEnabled());
        if (request.getFriendRequestAcceptedEnabled() != null) preferences.setFriendRequestAcceptedEnabled(request.getFriendRequestAcceptedEnabled());
        if (request.getFriendRequestRejectedEnabled() != null) preferences.setFriendRequestRejectedEnabled(request.getFriendRequestRejectedEnabled());
        
        // Analytics Service Notifications
        if (request.getWeeklySummaryEnabled() != null) preferences.setWeeklySummaryEnabled(request.getWeeklySummaryEnabled());
        if (request.getMonthlyReportEnabled() != null) preferences.setMonthlyReportEnabled(request.getMonthlyReportEnabled());
        if (request.getSpendingTrendAlertEnabled() != null) preferences.setSpendingTrendAlertEnabled(request.getSpendingTrendAlertEnabled());
        
        // System Notifications
        if (request.getSecurityAlertEnabled() != null) preferences.setSecurityAlertEnabled(request.getSecurityAlertEnabled());
        if (request.getAppUpdateEnabled() != null) preferences.setAppUpdateEnabled(request.getAppUpdateEnabled());
        if (request.getMaintenanceNoticeEnabled() != null) preferences.setMaintenanceNoticeEnabled(request.getMaintenanceNoticeEnabled());
        
        // JSON Configuration
        if (request.getNotificationPreferencesJson() != null) preferences.setNotificationPreferencesJson(request.getNotificationPreferencesJson());
        
        // Legacy fields
        if (request.getBudgetAlertsEnabled() != null) preferences.setBudgetAlertsEnabled(request.getBudgetAlertsEnabled());
        if (request.getDailyRemindersEnabled() != null) preferences.setDailyRemindersEnabled(request.getDailyRemindersEnabled());
        if (request.getWeeklyReportsEnabled() != null) preferences.setWeeklyReportsEnabled(request.getWeeklyReportsEnabled());
        if (request.getMonthlySummaryEnabled() != null) preferences.setMonthlySummaryEnabled(request.getMonthlySummaryEnabled());
        if (request.getGoalNotificationsEnabled() != null) preferences.setGoalNotificationsEnabled(request.getGoalNotificationsEnabled());
        if (request.getUnusualSpendingAlerts() != null) preferences.setUnusualSpendingAlerts(request.getUnusualSpendingAlerts());
        ...
        if (request.getInAppNotifications() != null) preferences.setInAppNotifications(request.getInAppNotifications());
        if (request.getBudgetWarningThreshold() != null) preferences.setBudgetWarningThreshold(request.getBudgetWarningThreshold());
    }
