...
export const QUICK_ACTIONS = [
  // Tour Guide
  {
    ...
    icon: "🚶",
    keywords: ["restart", "tour", "guide", "walkthrough", "help", "tutorial", "onboarding"],
    priority: 10,
  },
  // Expense Actions
  {
  ...
  // Payment Method Actions
  {
    ...
    icon: "💳",
    keywords: ["add", "create", "new", "payment", "method", "card", "bank", "wallet"],
    priority: 1,
  },
  {
  ...
  // ========================================
  {
    ...
    route: "/reports?tab=0",
    icon: "📧",
    keywords: ["generate", "reports", "email", "expense", "send", "create", "pdf"],
    priority: 1,
  },
  {
    id: "reports-history",
    ...
    route: "/reports?tab=1",
    icon: "📜",
    keywords: ["reports", "history", "past", "previous", "generated", "archive"],
    priority: 1,
  },
  {
    ...
    route: "/reports?tab=2",
    icon: "📊",
    keywords: ["analytics", "charts", "graphs", "statistics", "trends", "visualization"],
    priority: 1,
  },
  ...
  // ========================================
  {
    ...
    route: "/friends?tab=0",
    icon: "💡",
    keywords: ["friends", "suggestions", "recommended", "add", "find", "discover"],
    priority: 1,
  },
  {
    id: "friends-requests",
    ...
    route: "/friends?tab=1",
    icon: "📩",
    keywords: ["friends", "requests", "pending", "incoming", "accept", "decline"],
    priority: 1,
  },
  {
  ...
  },
  {
    ...
    route: "/friends?tab=3",
    icon: "🔗",
    keywords: ["friends", "shared", "expenses", "access", "sharing", "permissions"],
    priority: 1,
  },
  ...
  // ========================================
  {
    ...
    route: "/payment-method",
    icon: "💳",
    keywords: ["payment", "methods", "list", "all", "cards", "banks", "wallets"],
    priority: 2,
  },
  {
  ...
  // ========================================
  {
    ...
    route: "/bill",
    icon: "📄",
    keywords: ["bills", "list", "all", "subscriptions", "recurring", "payments"],
    priority: 2,
  },
  {
    id: "bill-upload",
  ...
  // ========================================
  {
    ...
    route: "/settings?section=appearance&highlight=themeMode",
    icon: "🌙",
  ...
  },
  {
    ...
    route: "/settings?section=appearance&highlight=enableAnimations",
    icon: "✨",
  ...
  },
  {
    ...
    route: "/settings?section=appearance&highlight=highContrastMode",
    icon: "🔲",
  ...
  },
  {
    ...
    route: "/settings?section=privacy_security&highlight=twoFactorEnabled",
    icon: "🔐",
  ...
  },
  {
    ...
    route: "/settings?section=privacy_security&highlight=configureMfa",
    icon: "📱",
  ...
  },
  {
    ...
    route: "/settings?section=data_storage&highlight=viewStorage",
    icon: "📊",
  ...
  },
  {
    ...
    route: "/settings?section=accessibility&highlight=screenReaderSupport",
    icon: "🔊",
  ...
  },
  {
    ...
    icon: "🏷️",
    keywords: ["shortcut", "indicators", "badges", "alt", "overlay", "hints", "display"],
    priority: 2,
  },
  {
  ...
  },
  {
    ...
    route: "/settings?section=accessibility&highlight=enhancedFocusIndicators",
    icon: "🎯",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=expense_service&highlight=expense_added",
    icon: "➕",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=expense_service&highlight=large_expense",
    icon: "⚠️",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=budget_service&highlight=budget_exceeded",
    icon: "🚨",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=budget_service&highlight=budget_warning",
    icon: "⚡",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=budget_service&highlight=budget_approaching",
    icon: "📈",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=bill_service&highlight=bill_due_reminder",
    icon: "📅",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=bill_service&highlight=bill_overdue",
    icon: "🚨",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=category_service&highlight=category_budget_exceeded",
    icon: "⚠️",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=payment_method_service&highlight=payment_method_added",
    icon: "🔔",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=friend_service&highlight=friend_request",
    icon: "🤝",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=friend_service&highlight=friend_request_accepted",
    icon: "🎉",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=friend_activity_service&highlight=friend_bill_created",
    icon: "📄",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=analytics_service&highlight=weekly_summary",
    icon: "📅",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=analytics_service&highlight=monthly_report",
    icon: "📈",
  ...
  },
  {
    ...
    route: "/settings/notifications?service=analytics_service&highlight=spending_goal",
    icon: "🎯",
  ...
  // Admin Dashboard
  {
    ...
    icon: "🏠",
    keywords: ["admin", "dashboard", "home", "overview", "metrics", "system", "panel"],
    priority: 0,
  ...
  // User Management
  {
    ...
    route: "/admin/users",
    icon: "👥",
    keywords: ["users", "management", "accounts", "members", "people", "admin", "manage"],
    priority: 1,
    mode: SEARCH_MODES.ADMIN,
  },
  ...
  // Role Management
  {
    ...
    route: "/admin/roles",
    icon: "🔐",
    keywords: ["roles", "permissions", "access", "control", "admin", "security", "manage"],
    priority: 1,
    mode: SEARCH_MODES.ADMIN,
  },
  ...
  // System Analytics
  {
    ...
    icon: "📊",
    keywords: ["analytics", "statistics", "metrics", "charts", "reports", "system", "data"],
    priority: 1,
    mode: SEARCH_MODES.ADMIN,
  },
  ...
  // Audit Logs
  {
    ...
    route: "/admin/audit",
    icon: "📋",
    keywords: ["audit", "logs", "activity", "history", "trail", "security", "tracking"],
    priority: 1,
    mode: SEARCH_MODES.ADMIN,
  },
  ...
  // Admin Reports
  {
    ...
    route: "/admin/reports",
    icon: "📈",
    keywords: ["reports", "system", "generate", "export", "summary", "admin", "statistics"],
    priority: 1,
    mode: SEARCH_MODES.ADMIN,
  },
  ...
  // Admin Settings
  {
    ...
    icon: "⚙️",
    keywords: ["settings", "configuration", "system", "preferences", "admin", "config", "setup"],
    priority: 1,
    mode: SEARCH_MODES.ADMIN,
  },
...
export const searchQuickActions = (query, currentMode = SEARCH_MODES.USER) => {
  ...
  return modeFilteredActions
    .map((action) => {
      ...
      const keywordMatches = action.keywords.map((kw) => fuzzyMatch(kw, queryLower));
...
function resolveCategoryForCommand(action) {
  if (action.section === "settings" || action.section === "notifications") {
    return "Settings";
  }
  if (action.type === SEARCH_TYPES.SETTING || action.type === SEARCH_TYPES.NOTIFICATION) {
    return "Settings";
  }
  return "Actions";
}
...
function resolveSectionLabel(section) {
  const raw = SECTION_LABELS[section] || section || "actions";
  if (raw.startsWith("search.sections.")) {
    return raw.replace("search.sections.", "").replace(/_/g, " ");
  }
  return raw;
}

export const buildCatalogCommandActions = (currentMode = SEARCH_MODES.USER) =>
  filterByMode(QUICK_ACTIONS, currentMode).map((action) => ({
    ...
    category: resolveCategoryForCommand(action),
    section: resolveSectionLabel(action.section),
    icon: action.icon || TYPE_ICONS[action.type] || "⚡",
    route: String(action.route || "").startsWith("#action:") ? "" : action.route,
    priority: Number.isFinite(action.priority) ? action.priority : 3,
  }));

export const buildQuickActions = (mode = SEARCH_MODES.USER, t = (key) => key) =>
  filterByMode(QUICK_ACTIONS, mode).map((action) => ({
    id: action.id,
    key: `action-${action.id}`,
    type: action.type,
    label: action.titleKey ? t(action.titleKey) : action.title,
    description: action.subtitleKey ? t(action.subtitleKey) : action.subtitle,
    route: action.route,
    icon: action.icon,
    searchValue: [action.title, action.subtitle, action.route, ...(action.keywords || [])]
      .filter(Boolean)
      .join(" "),
...
export const filterQuickActions = (actions, query) => {
  if (!query?.trim()) return actions;
  const lower = query.toLowerCase();
  return actions.filter((action) => {
    const base =
      `${action.label || ""} ${action.description || ""} ${action.searchValue || ""}`.toLowerCase();
    if (base.includes(lower)) return true;
    return (action.keywords || []).some((keyword) => String(keyword).toLowerCase().includes(lower));
  });
};
