# payment-methods Feature Boundary

## Scope
- Own UI flows and user interactions for the 'payment-methods' feature.
- Keep business logic in src/domain/paymentmethods when applicable.
