# notifications Feature Boundary

## Scope
- Own UI flows and user interactions for the 'notifications' feature.
- Keep business logic in src/domain/notifications when applicable.
