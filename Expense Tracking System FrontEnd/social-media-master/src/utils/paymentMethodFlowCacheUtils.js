...
export const getPaymentMethodFlowCacheDescriptor = (params = {}) => ({
...
export const getPaymentMethodFlowCacheKeyFromDescriptor = (descriptor = {}) =>
  JSON.stringify(descriptor);

export const getPaymentMethodFlowCacheKey = (params = {}) =>
  getPaymentMethodFlowCacheKeyFromDescriptor(
    getPaymentMethodFlowCacheDescriptor(params)
  );
