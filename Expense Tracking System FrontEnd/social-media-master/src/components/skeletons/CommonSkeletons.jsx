...
export const RecurringLossGainCardsSkeleton = ({ rows = 5 }) => {
  ...
  return (
    <>
      ...
      <TopRecurringExpensesSkeleton rows={rows} />
...
/**
 * TopRecurringExpensesSkeleton - Skeleton for the Top Recurring Expenses card
 * Shows a list of skeleton rows matching the actual component structure
 */
export const TopRecurringExpensesSkeleton = ({ rows = 5 }) => {
  const { colors, mode } = useTheme();
...
/**
 * LossGainBreakdownSkeleton - Skeleton for the Loss/Gain Breakdown card
 * Shows a bar chart skeleton with legend and summary pills
 */
export const LossGainBreakdownSkeleton = () => {
  const { colors, mode } = useTheme();
