...
const ALT_SHORTCUTS = {
  ...
  'nav-dashboard': { key: 'D', labelKey: 'navigation.home', selector: '[data-shortcut="dashboard"]' },
  'nav-expenses': { key: 'E', labelKey: 'navigation.expenses', selector: '[data-shortcut="expenses"]' },
  'nav-budgets': { key: 'B', labelKey: 'navigation.budgets', selector: '[data-shortcut="budgets"]' },
  'nav-bills': { key: 'I', labelKey: 'navigation.bill', selector: '[data-shortcut="bills"]' },
  'nav-categories': { key: 'C', labelKey: 'navigation.categories', selector: '[data-shortcut="categories"]' },
  'nav-payments': { key: 'P', labelKey: 'navigation.payments', selector: '[data-shortcut="payments"]' },
  'nav-friends': { key: 'F', labelKey: 'navigation.friends', selector: '[data-shortcut="friends"]' },
  'nav-groups': { key: 'G', labelKey: 'navigation.groups', selector: '[data-shortcut="groups"]' },
  'nav-reports': { key: 'R', labelKey: 'navigation.reports', selector: '[data-shortcut="reports"]' },
  'nav-settings': { key: 'S', labelKey: 'navigation.settings', selector: '[data-shortcut="settings"]' },
  'nav-calendar': { key: 'L', labelKey: 'keyboard.calendar', selector: '[data-shortcut="calendar"]' },
  
  // Actions - Header bar
  'action-theme': { key: 'T', labelKey: 'keyboard.toggleTheme', selector: '[data-shortcut="theme"]' },
  'action-masking': { key: 'M', labelKey: 'keyboard.toggleMasking', selector: '[data-shortcut="masking"]' },
  'action-search': { key: 'K', labelKey: 'keyboard.search', selector: '[data-shortcut="search"]' },
  'action-help': { key: '/', labelKey: 'keyboard.help', selector: '[data-shortcut="help"]' },
};
